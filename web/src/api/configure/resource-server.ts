...
import {
  AllResourceServerRes,
  PageServerResourceReq,
  PageServerResourceRes,
} from './types/resource-server';

export function allResourceServer(id: number) {
  return axios.get<AllResourceServerRes>('/configure/v1/resource/servers', {
