  ...
  <div class="configure">
    <div class="header">
      <div class="header-item">
        <a-button
          v-permission="'configure:configure:preview'"
          type="primary"
          status="success"
    ...
    <a-modal
      v-model:visible="envVisible"
      simple
      title="请选择环境"
      @cancel="envVisible = false"
      @before-ok="handleChooseEnv"
    >
...
<script setup lang="ts">
  ...
  import {
    CompareTemplateInfo,
    Template,
  } from '@/api/configure/types/template';
  ...
  const submitTemplate = async () => {
    ...
    if (submitTemplateForm.format === 'json') {
      submitTemplateForm.content = JSON.stringify(
        JSON.parse(submitTemplateForm.content)
      );
    } else {
