		...
		ResourceValue: []*biz.ResourceValue{
			{
				...
				Value: util.MarshalString(map[string]any{
					...
					"Whitelist": map[string]bool{
						...
						"POST:/manager/v1/user/login/captcha":     true,
						"POST:/manager/v1/user/login":             true,
						"POST:/manager/v1/user/token/refresh":     true,
						"GET:/manager/client/v1/dictionary/value": true,
