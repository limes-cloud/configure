...
// Validate checks the field values on AddEnvReply with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on AddEnvReply with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in AddEnvReplyMultiError, or
// nil if none found.
func (m *AddEnvReply) ValidateAll() error {
	return m.validate(true)
}

func (m *AddEnvReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return AddEnvReplyMultiError(errors)
	}

	return nil
}

// AddEnvReplyMultiError is an error wrapping multiple validation errors
// returned by AddEnvReply.ValidateAll() if the designated constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m AddEnvReplyMultiError) AllErrors() []error { return m }

// AddEnvReplyValidationError is the validation error returned by
// AddEnvReply.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e AddEnvReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AddEnvReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AddEnvReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AddEnvReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AddEnvReplyValidationError) ErrorName() string { return "AddEnvReplyValidationError" }
...
var _ error = AddEnvReplyValidationError{}
