...
func (c *serviceClient) GetConfig(ctx context.Context, in *GetConfigRequest, opts ...grpc.CallOption) (*GetConfigReply, error) {
	out := new(GetConfigReply)
	err := c.cc.Invoke(ctx, Service_GetConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) WatchConfig(ctx context.Context, in *GetConfigRequest, opts ...grpc.CallOption) (Service_WatchConfigClient, error) {
...
func (x *serviceWatchConfigClient) Recv() (*GetConfigReply, error) {
...
func (x *serviceWatchConfigServer) Send(m *GetConfigReply) error {
