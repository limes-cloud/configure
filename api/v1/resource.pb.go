...
type PageResourceReply struct {
	...
	List []*PageResourceReply_Server `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
}
...
func (x *PageResourceReply) GetList() []*PageResourceReply_Server {
	if x != nil {
		return x.List
	}
	return nil
...
type PageResourceReply_Server struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PageResourceReply_Server) Reset() {
	*x = PageResourceReply_Server{}
	if protoimpl.UnsafeEnabled {
...
func (x *PageResourceReply_Server) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PageResourceReply_Server) ProtoMessage() {}

func (x *PageResourceReply_Server) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PageResourceReply_Server.ProtoReflect.Descriptor instead.
func (*PageResourceReply_Server) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{1, 0}
}

func (x *PageResourceReply_Server) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *PageResourceReply_Server) GetKeyword() string {
	if x != nil {
		return x.Keyword
	}
	return ""
...
func (x *PageResourceReply_Server) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PageResourceReply_Server) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *PageResourceReply_Server) GetFields() string {
	if x != nil {
		return x.Fields
	}
	return ""
...
func (x *PageResourceReply_Server) GetTag() string {
	if x != nil {
		return x.Tag
	}
	return ""
...
var file_resource_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa4, 0x01,
	0x0a, 0x13, 0x50, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65,
	...
	,
	...
	0x67, 0x22, 0xbb, 0x01, 0x0a, 0x12, 0x41, 0x64, 0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x23, 0x0a, 0x07, 0x6b, 0x65, 0x79, 0x77,
	...
	0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x09, 0xfa, 0x42, 0x06, 0x72, 0x04, 0x10, 0x01,
	0x18, 0x20, 0x52, 0x03, 0x74, 0x61, 0x67, 0x12, 0x16, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64,
	0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22,
	0xd7, 0x01, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	...
	0x69, 0x64, 0x12, 0x23, 0x0a, 0x07, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x09, 0xfa, 0x42, 0x06, 0x72, 0x04, 0x10, 0x01, 0x18, 0x20, 0x52, 0x07,
	0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x1d, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1b, 0x0a, 0x03, 0x74, 0x61, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x09, 0xfa, 0x42, 0x06, 0x72, 0x04, 0x10, 0x01, 0x18, 0x20, 0x52, 0x03, 0x74, 0x61,
	0x67, 0x12, 0x16, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22, 0x30, 0x0a, 0x15, 0x44, 0x65, 0x6c,
	...
	0xfa, 0x42, 0x04, 0x22, 0x02, 0x20, 0x00, 0x52, 0x02, 0x69, 0x64, 0x42, 0x09, 0x5a, 0x07, 0x2e,
...
var file_resource_proto_goTypes = []interface{}{
	(*PageResourceRequest)(nil),      // 0: v1.PageResourceRequest
	(*PageResourceReply)(nil),        // 1: v1.PageResourceReply
	(*AddResourceRequest)(nil),       // 2: v1.AddResourceRequest
	(*UpdateResourceRequest)(nil),    // 3: v1.UpdateResourceRequest
	(*DeleteResourceRequest)(nil),    // 4: v1.DeleteResourceRequest
	(*PageResourceReply_Server)(nil), // 5: v1.PageResourceReply.Server
}
var file_resource_proto_depIdxs = []int32{
	5, // 0: v1.PageResourceReply.list:type_name -> v1.PageResourceReply.Server
...
func file_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_resource_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PageResourceReply_Server); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
