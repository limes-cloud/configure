...
// Validate checks the field values on AddServerReply with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on AddServerReply with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in AddServerReplyMultiError,
// or nil if none found.
func (m *AddServerReply) ValidateAll() error {
	return m.validate(true)
}

func (m *AddServerReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return AddServerReplyMultiError(errors)
	}

	return nil
}

// AddServerReplyMultiError is an error wrapping multiple validation errors
// returned by AddServerReply.ValidateAll() if the designated constraints
// aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m AddServerReplyMultiError) AllErrors() []error { return m }

// AddServerReplyValidationError is the validation error returned by
// AddServerReply.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e AddServerReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AddServerReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AddServerReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AddServerReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AddServerReplyValidationError) ErrorName() string { return "AddServerReplyValidationError" }
...
var _ error = AddServerReplyValidationError{}
