...
func IsBusinessValueError(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_BusinessValueError.String() && e.Code == 200
}

func BusinessValueErrorFormat(format string, args ...any) *errors.Error {
	return errors.New(200, ErrorReason_BusinessValueError.String(), "业务值错误:"+fmt.Sprintf(format, args...))
}

func BusinessValueError() *errors.Error {
	return errors.New(200, ErrorReason_BusinessValueError.String(), "业务值错误")
}
