...
func (x *GetServerReply) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetServerReply) GetKeyword() string {
	if x != nil {
		return x.Keyword
	}
	return ""
...
func (x *GetServerReply) GetDescription() string {
...
func (x *GetServerReply) GetStatus() bool {
...
func (x *GetServerReply) GetCreatedAt() uint32 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *GetServerReply) GetUpdatedAt() uint32 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
func (*DeleteServerRequest) Descriptor() ([]byte, []int) {
	return file_api_configure_server_configure_server_proto_rawDescGZIP(), []int{8}
}

func (x *DeleteServerRequest) GetIds() []uint32 {
	if x != nil {
		return x.Ids
	}
	return nil
...
func (x *DeleteServerReply) Reset() {
	*x = DeleteServerReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_configure_server_configure_server_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteServerReply) Descriptor() ([]byte, []int) {
	return file_api_configure_server_configure_server_proto_rawDescGZIP(), []int{9}
}

func (x *DeleteServerReply) GetTotal() uint32 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *UpdateServerStatusRequest) Reset() {
	*x = UpdateServerStatusRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_configure_server_configure_server_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateServerStatusRequest) Descriptor() ([]byte, []int) {
	return file_api_configure_server_configure_server_proto_rawDescGZIP(), []int{10}
}
...
func (x *UpdateServerStatusRequest) GetStatus() bool {
	if x != nil {
		return x.Status
	}
	return false
...
type UpdateServerStatusReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *UpdateServerStatusReply) Reset() {
	*x = UpdateServerStatusReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_configure_server_configure_server_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *UpdateServerStatusReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateServerStatusReply) ProtoMessage() {}

func (x *UpdateServerStatusReply) ProtoReflect() protoreflect.Message {
	mi := &file_api_configure_server_configure_server_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateServerStatusReply.ProtoReflect.Descriptor instead.
func (*UpdateServerStatusReply) Descriptor() ([]byte, []int) {
	return file_api_configure_server_configure_server_proto_rawDescGZIP(), []int{11}
}
...
func (x *ListServerReply_Server) Reset() {
	*x = ListServerReply_Server{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_configure_server_configure_server_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_api_configure_server_configure_server_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6b, 0x0a, 0x10, 0x47, 0x65, 0x74,
	...
	0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x22, 0xe9, 0x01, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x75, 0x73, 0x22, 0xb9, 0x02, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76, 0x65,
	...
	0x20, 0x00, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x2b, 0x0a, 0x05,
	...
	,
	...
	0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x22, 0xa5, 0x01, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61,
	...
	,
	...
	0x07, 0xfa, 0x42, 0x04, 0x2a, 0x02, 0x20, 0x00, 0x52, 0x02, 0x69, 0x64, 0x12, 0x16, 0x0a, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x22, 0x19, 0x0a, 0x17, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42,
	0x38, 0x0a, 0x21, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x65, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x65, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x2e, 0x76, 0x31, 0x42, 0x08, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x56, 0x31, 0x50, 0x01,
...
var file_api_configure_server_configure_server_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_api_configure_server_configure_server_proto_goTypes = []interface{}{
	(*GetServerRequest)(nil),          // 0: configure.api.configure.server.v1.GetServerRequest
	(*GetServerReply)(nil),            // 1: configure.api.configure.server.v1.GetServerReply
	...
	(*CreateServerRequest)(nil),       // 4: configure.api.configure.server.v1.CreateServerRequest
	(*CreateServerReply)(nil),         // 5: configure.api.configure.server.v1.CreateServerReply
	(*UpdateServerRequest)(nil),       // 6: configure.api.configure.server.v1.UpdateServerRequest
	(*UpdateServerReply)(nil),         // 7: configure.api.configure.server.v1.UpdateServerReply
	(*DeleteServerRequest)(nil),       // 8: configure.api.configure.server.v1.DeleteServerRequest
	(*DeleteServerReply)(nil),         // 9: configure.api.configure.server.v1.DeleteServerReply
	(*UpdateServerStatusRequest)(nil), // 10: configure.api.configure.server.v1.UpdateServerStatusRequest
	(*UpdateServerStatusReply)(nil),   // 11: configure.api.configure.server.v1.UpdateServerStatusReply
	(*ListServerReply_Server)(nil),    // 12: configure.api.configure.server.v1.ListServerReply.Server
}
var file_api_configure_server_configure_server_proto_depIdxs = []int32{
	12, // 0: configure.api.configure.server.v1.ListServerReply.list:type_name -> configure.api.configure.server.v1.ListServerReply.Server
...
func file_api_configure_server_configure_server_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_configure_server_configure_server_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_configure_server_configure_server_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_configure_server_configure_server_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateServerStatusReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_configure_server_configure_server_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_configure_server_configure_server_proto_msgTypes[1].OneofWrappers = []interface{}{}
	...
	file_api_configure_server_configure_server_proto_msgTypes[6].OneofWrappers = []interface{}{}
	file_api_configure_server_configure_server_proto_msgTypes[12].OneofWrappers = []interface{}{}
	type x struct{}
