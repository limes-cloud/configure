...
func (m *GetServerRequest) validate(all bool) error {
	...
	if m.Id != nil {
		...
		if m.GetId() <= 0 {
			err := GetServerRequestValidationError{
				field:  "Id",
...
func (m *DeleteServerRequest) validate(all bool) error {
	...
	_DeleteServerRequest_Ids_Unique := make(map[uint32]struct{}, len(m.GetIds()))

	for idx, item := range m.GetIds() {
		_, _ = idx, item

		if _, exists := _DeleteServerRequest_Ids_Unique[item]; exists {
			err := DeleteServerRequestValidationError{
			...
			_DeleteServerRequest_Ids_Unique[item] = struct{}{}
		}
...
// ValidateAll checks the field values on UpdateServerStatusRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateServerStatusRequestMultiError, or nil if none found.
func (m *UpdateServerStatusRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateServerStatusRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetId() <= 0 {
		err := UpdateServerStatusRequestValidationError{
			field:  "Id",
			reason: "value must be greater than 0",
		}
		if !all {
	...
	if len(errors) > 0 {
		return UpdateServerStatusRequestMultiError(errors)
	}

	return nil
}

// UpdateServerStatusRequestMultiError is an error wrapping multiple validation
// errors returned by UpdateServerStatusRequest.ValidateAll() if the
// designated constraints aren't met.
type UpdateServerStatusRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateServerStatusRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateServerStatusRequestMultiError) AllErrors() []error { return m }
...
// Validate checks the field values on UpdateServerStatusReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateServerStatusReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateServerStatusReply with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateServerStatusReplyMultiError, or nil if none found.
func (m *UpdateServerStatusReply) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateServerStatusReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateServerStatusReplyMultiError(errors)
	}

	return nil
}

// UpdateServerStatusReplyMultiError is an error wrapping multiple validation
// errors returned by UpdateServerStatusReply.ValidateAll() if the designated
// constraints aren't met.
type UpdateServerStatusReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateServerStatusReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateServerStatusReplyMultiError) AllErrors() []error { return m }

// UpdateServerStatusReplyValidationError is the validation error returned by
// UpdateServerStatusReply.Validate if the designated constraints aren't met.
type UpdateServerStatusReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateServerStatusReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateServerStatusReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateServerStatusReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateServerStatusReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateServerStatusReplyValidationError) ErrorName() string {
	return "UpdateServerStatusReplyValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateServerStatusReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateServerStatusReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateServerStatusReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateServerStatusReplyValidationError{}
