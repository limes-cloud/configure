...
// Validate checks the field values on GetResourceReply_Server with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on GetResourceReply_Server with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetResourceReply_ServerMultiError, or nil if none found.
func (m *GetResourceReply_Server) ValidateAll() error {
	return m.validate(true)
}

func (m *GetResourceReply_Server) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetResourceReply_ServerMultiError(errors)
	}

	return nil
}

// GetResourceReply_ServerMultiError is an error wrapping multiple validation
// errors returned by GetResourceReply_Server.ValidateAll() if the designated
// constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m GetResourceReply_ServerMultiError) AllErrors() []error { return m }

// GetResourceReply_ServerValidationError is the validation error returned by
// GetResourceReply_Server.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e GetResourceReply_ServerValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetResourceReply_ServerValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetResourceReply_ServerValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetResourceReply_ServerValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetResourceReply_ServerValidationError) ErrorName() string {
	return "GetResourceReply_ServerValidationError"
}
...
func (e GetResourceReply_ServerValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sGetResourceReply_Server.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetResourceReply_ServerValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetResourceReply_ServerValidationError{}
