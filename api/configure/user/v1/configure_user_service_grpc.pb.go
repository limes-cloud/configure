...
const (
	User_Login_FullMethodName        = "/configure.api.configure.user.v1.User/Login"
	User_RefreshToken_FullMethodName = "/configure.api.configure.user.v1.User/RefreshToken"
)
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "configure.api.configure.user.v1.User",
	...
	Metadata: "api/configure/user/configure_user_service.proto",
}
