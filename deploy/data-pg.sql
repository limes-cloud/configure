...
-- Records of env
-- ----------------------------
INSERT INTO "public"."env" VALUES (1, 1712995716, 1719369848, 'TEST                            ', '测试环境', '用于本地测试', '1025D32F6CA7A2A320FE091B22C5DF3C', 1);
INSERT INTO "public"."env" VALUES (2, 1712995716, 1750762479, 'PRE                             ', '预发布环境', '用于上线前测试', '862BBE3D5BE34A780305DA84A8DD5147', 0);
INSERT INTO "public"."env" VALUES (3, 1712995716, 1750762481, 'PROD                            ', '生产环境', '用于线上真实环境', '5B655B7D4A51BF79C974C9F27C27D992', 0);
...
-- Records of resource
-- ----------------------------
INSERT INTO "public"."resource" VALUES (1, 1712995716, 1712995716, 'Env                             ', '环境标识信息', 'Keyword', 'env', 0);
INSERT INTO "public"."resource" VALUES (2, 1712995716, 1712995716, 'AdminJwt                        ', '后台管理服务jwt配置信息', 'Secret,Expire,Renewal,Whitelist', 'jwt', 0);
INSERT INTO "public"."resource" VALUES (3, 1712995716, 1712995716, 'ClientJwt                       ', '客户端服务jwt配置信息', 'Secret,Expire,Renewal,Whitelist', 'jwt', 0);
INSERT INTO "public"."resource" VALUES (4, 1712995716, 1712995716, 'Redis                           ', 'redis中间件配置信息', 'Host,Username,Password,Port', 'redis', 0);
INSERT INTO "public"."resource" VALUES (5, 1712995716, 1712995716, 'Email                           ', '邮箱服务配置信息', 'Username,Company,Password,Host,Port', 'email', 0);
INSERT INTO "public"."resource" VALUES (6, 1712995716, 1712995716, 'GatewayServer                   ', '通用网关服务配置信息', 'HttpPort,Host,Timeout', 'server', 0);
INSERT INTO "public"."resource" VALUES (7, 1712995716, 1712995716, 'ManagerServer                   ', '管理中心服务配置信息', 'Host,HttpPort,GrpcPort,Timeout', 'server', 0);
INSERT INTO "public"."resource" VALUES (8, 1712995716, 1712995716, 'ManagerDatabase                 ', '管理中心数据库配置', 'Username,Password,Type,Port,Database,Option,Host', 'mysql', 1);
INSERT INTO "public"."resource" VALUES (9, 1712995716, 1712995716, 'ResourceServer                  ', '资源中心服务配置信息', 'Host,HttpPort,GrpcPort,Timeout', 'server', 0);
INSERT INTO "public"."resource" VALUES (10, 1712995716, 1712995716, 'ResourceDatabase                ', '资源中心数据库配置信息', 'Username,Password,Type,Port,Database,Option,Host', 'mysql', 1);
INSERT INTO "public"."resource" VALUES (11, 1712995716, 1712995716, 'CronServer                      ', '定时任务服务配置信息', 'Host,HttpPort,GrpcPort,Timeout', 'server', 0);
INSERT INTO "public"."resource" VALUES (12, 1712995716, 1712995716, 'CronDatabase                    ', '定时任务数据库配置信息', 'Username,Password,Type,Port,Database,Option,Host', 'mysql', 1);
INSERT INTO "public"."resource" VALUES (13, 1712995716, 1712995716, 'ConfigureServer                 ', '配置中心服务配置信息', 'Host,HttpPort,GrpcPort,Timeout', 'server', 0);
INSERT INTO "public"."resource" VALUES (14, 1712995716, 1728064624, 'ApplicationServer               ', '应用中心服务配置信息', 'Host,HttpPort,GrpcPort,Timeout', 'server', 0);
INSERT INTO "public"."resource" VALUES (15, 1712995716, 1728064632, 'ApplicationDatabase             ', '应用中心数据库配置信息', 'Username,Password,Type,Port,Database,Option,Host', 'mysql', 1);
INSERT INTO "public"."resource" VALUES (16, 1712995716, 1712995716, 'PartyAffairsServer              ', '信号灯服务配置信息', 'Host,HttpPort,GrpcPort,Timeout', 'server', 0);
INSERT INTO "public"."resource" VALUES (17, 1712995716, 1719371833, 'PartyAffairsDatabase            ', '信号灯数据库配置信息', 'Username,Password,Type,Port,Database,Option,Host', 'mysql', 1);
INSERT INTO "public"."resource" VALUES (19, 1723028903, 1723028903, 'PovertyDatabase                 ', '资助系统数据库信息', 'Username,Password,Type,Port,Database,Option,Host', 'mysql', 1);
INSERT INTO "public"."resource" VALUES (20, 1723028953, 1723028953, 'PovertyServer                   ', '资助系统服务信息', 'Host,Port,Timeout', 'server', 0);
...
-- Records of server
-- ----------------------------
INSERT INTO "public"."server" VALUES (1, 1712995716, 1719246376, 'Gateway                         ', '通用网关', '主要负责前端到后端的转发', 1);
INSERT INTO "public"."server" VALUES (2, 1712995716, 1750762065, 'Manager                         ', '管理中心', '主要负责系统的基础管理', 1);
INSERT INTO "public"."server" VALUES (3, 1712995716, 1719283436, 'Resource                        ', '资源中心', '主要负责静态资源的管理', 1);
INSERT INTO "public"."server" VALUES (4, 1712995716, 1719634247, 'Cron                            ', '定时任务', '主要负责定时任务的管理', 1);
INSERT INTO "public"."server" VALUES (5, 1712995716, 1728064298, 'Application                     ', '应用中心', '主要负责业务应用的管理', 1);
INSERT INTO "public"."server" VALUES (6, 1712995716, 1750772337, 'PartyAffairs                    ', '信号灯系统', '指尖上的党务系统', 1);
INSERT INTO "public"."server" VALUES (9, 1723027582, 1750772356, 'Poverty                         ', '资助系统', '资助系统', 1);
...
business:
  defaultPasswordExpire: 10s
  defaultNickName: 用户-
', '0D01EEE78E5662F3193361C9EEE34266', 0, 'yaml', '初始化模板', '[{"type":"update","key":"business","old":"service:\n    resource: ${ResourceServer.Host}:${ResourceServer.GrpcPort}\n","cur":"defaultNickName: 用户-\ndefaultPasswordExpire: 10s\n"},{"type":"update","key":"log","old":"file:\n    compress: false\n    maxAge: 1\n    maxBackup: 5\n    maxSize: 1\n    name: ./tmp/runtime/output.log\nlevel: 0\noutput:\n    - stdout\n    - file\n","cur":"caller: true\nfile:\n    compress: false\n    maxAge: 1\n    maxBackup: 5\n    maxSize: 1\n    name: ./tmp/runtime/output.log\nlevel: 0\noutput:\n    - stdout\n    - file\n"}]');
...
business:
  key: value
', 'C5A5395CF93921829673B76AEFC4AE1A', 0, 'yaml', '初始化模板', '[{"type":"update","key":"log","old":"file:\n    compress: false\n    maxAge: 1\n    maxBackup: 5\n    maxSize: 1\n    name: ./tmp/runtime/output.log\nlevel: 0\noutput:\n    - stdout\n    - file\n","cur":"caller: true\nfile:\n    compress: false\n    maxAge: 1\n    maxBackup: 5\n    maxSize: 1\n    name: ./tmp/runtime/output.log\nlevel: 0\noutput:\n    - stdout\n    - file\n"},{"type":"update","key":"database","old":"system:\n    autoCreate: true\n    config:\n        initializer:\n            enable: true\n            path: deploy/data.sql\n        logLevel: 3\n        maxIdleConn: 10\n        maxLifetime: 2h\n        maxOpenConn: 20\n        slowThreshold: 2s\n        transformError:\n            enable: true\n    connect:\n        dbName: ${CronDatabase.Database}\n        host: ${CronDatabase.Host}\n        option: ${CronDatabase.Option}\n        password: ${CronDatabase.Password}\n        port: ${CronDatabase.Port}\n        username: ${CronDatabase.Username}\n    drive: ${CronDatabase.Type}\n    enable: true\n","cur":"system:\n    autoCreate: true\n    config:\n        initializer:\n            enable: true\n            path: deploy/data.sql\n        logLevel: 4\n        maxIdleConn: 10\n        maxLifetime: 2h\n        maxOpenConn: 20\n        slowThreshold: 2s\n        transformError:\n            enable: true\n    connect:\n        dbName: ${CronDatabase.Database}\n        host: ${CronDatabase.Host}\n        option: ${CronDatabase.Option}\n        password: ${CronDatabase.Password}\n        port: ${CronDatabase.Port}\n        username: ${CronDatabase.Username}\n    drive: ${CronDatabase.Type}\n    enable: true\n"}]');
...
business:
  key: value
', '2494002DB6A751C727E337352C1084CA', 1, 'yaml', '初始化模板', '[{"type":"add","key":"redis","old":"","cur":"cache:\n    enable: true\n    host: ${Redis.Host}:${Redis.Port}\n    password: ${Redis.Password}\n    username: ${Redis.Username}\n"},{"type":"update","key":"log","old":"caller: true\nfile:\n    compress: false\n    maxAge: 1\n    maxBackup: 5\n    maxSize: 1\n    name: ./tmp/runtime/output.log\nlevel: 0\noutput:\n    - stdout\n    - file\n","cur":"caller: true\nfile:\n    compress: true\n    maxAge: 1\n    maxBackup: 5\n    maxSize: 1\n    name: ./tmp/runtime/output.log\nlevel: 0\noutput:\n    - stdout\n    - file\n"}]');
...
database:
  system:
    ...
    config:
      ...
      logLevel: 4 #日志等级
      slowThreshold: 2s #慢sql阈值
', '5080946CA7F15A5B8AC9F29648DD41EA', 0, 'yaml', '1', '[{"type":"del","key":"business","old":"auth:\n    yiBan:\n        appId: e4750b34230b48e1\n        appSecret: b0891a7f6018e5a76b085e3cb9548edd\n","cur":""}]');
...
business:
  aiBot:
    ...
    appid: ${botId}
    setting: ${botSetting}
', 'C590B3EEA4E514683EEBE01F293ACF39', 0, 'yaml', '初始化提交', '');
  ...
  - path: /poverty/client/*
    ...
    middlewares:
      - name: auth
        options:
          url: http://localhost:${GatewayServer.HttpPort}/application/client/v1/auth
          method: POST', '3020B1B4C417B67FE2480669A6087A34', 1, 'yaml', '新增应用中心', '[{"type":"update","key":"endpoints","old":"- backends:\n    - target: ${ManagerServer.Host}:${ManagerServer.HttpPort}\n  path: /manager/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ManagerServer.Timeout}\n- backends:\n    - target: ${ManagerServer.Host}:${ManagerServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/usercenter/client/v1/auth\n  path: /manager/client/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ManagerServer.Timeout}\n- backends:\n    - target: ${ConfigureServer.Host}:${ConfigureServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n  path: /configure/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ConfigureServer.Timeout}\n- backends:\n    - target: ${ResourceServer.Host}:${ResourceServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n        whiteList:\n            - method: GET\n              path: /resource/api/v1/static/*\n            - method: GET\n              path: /resource/api/v1/download/*\n  path: /resource/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ResourceServer.Timeout}\n- backends:\n    - target: ${ResourceServer.Host}:${ResourceServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/usercenter/client/v1/auth\n  path: /resource/client/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ResourceServer.Timeout}\n- backends:\n    - target: ${UserCenterServer.Host}:${UserCenterServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n  path: /usercenter/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${UserCenterServer.Timeout}\n- backends:\n    - target: ${UserCenterServer.Host}:${UserCenterServer.HttpPort}\n  path: /usercenter/client/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${UserCenterServer.Timeout}\n- backends:\n    - target: ${CronServer.Host}:${CronServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n  path: /cron/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${CronServer.Timeout}\n- backends:\n    - target: ${PartyAffairsServer.Host}:${PartyAffairsServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n  path: /partyaffairs/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${PartyAffairsServer.Timeout}\n- backends:\n    - target: ${PartyAffairsServer.Host}:${PartyAffairsServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/usercenter/client/v1/auth\n  path: /partyaffairs/client/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${PartyAffairsServer.Timeout}\n- backends:\n    - target: ${PovertyServer.Host}:${PovertyServer.Port}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n  path: /poverty/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${PovertyServer.Timeout}\n- backends:\n    - target: ${PovertyServer.Host}:${PovertyServer.Port}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/usercenter/client/v1/auth\n  path: /poverty/client/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${PovertyServer.Timeout}\n","cur":"- backends:\n    - target: ${ManagerServer.Host}:${ManagerServer.HttpPort}\n  path: /manager/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ManagerServer.Timeout}\n- backends:\n    - target: ${ManagerServer.Host}:${ManagerServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/application/client/v1/auth\n  path: /manager/client/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ManagerServer.Timeout}\n- backends:\n    - target: ${ConfigureServer.Host}:${ConfigureServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n  path: /configure/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ConfigureServer.Timeout}\n- backends:\n    - target: ${ResourceServer.Host}:${ResourceServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n        whiteList:\n            - method: GET\n              path: /resource/api/v1/static/*\n            - method: GET\n              path: /resource/api/v1/download/*\n  path: /resource/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ResourceServer.Timeout}\n- backends:\n    - target: ${ResourceServer.Host}:${ResourceServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/application/client/v1/auth\n  path: /resource/client/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ResourceServer.Timeout}\n- backends:\n    - target: ${ApplicationServer.Host}:${ApplicationServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n  path: /application/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ApplicationServer.Timeout}\n- backends:\n    - target: ${ApplicationServer.Host}:${ApplicationServer.HttpPort}\n  path: /application/client/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${ApplicationServer.Timeout}\n- backends:\n    - target: ${CronServer.Host}:${CronServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n  path: /cron/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${CronServer.Timeout}\n- backends:\n    - target: ${PartyAffairsServer.Host}:${PartyAffairsServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n  path: /partyaffairs/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${PartyAffairsServer.Timeout}\n- backends:\n    - target: ${PartyAffairsServer.Host}:${PartyAffairsServer.HttpPort}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/application/client/v1/auth\n  path: /partyaffairs/client/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${PartyAffairsServer.Timeout}\n- backends:\n    - target: ${PovertyServer.Host}:${PovertyServer.Port}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/manager/api/v1/auth\n  path: /poverty/api/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${PovertyServer.Timeout}\n- backends:\n    - target: ${PovertyServer.Host}:${PovertyServer.Port}\n  middlewares:\n    - name: auth\n      options:\n        method: POST\n        url: http://localhost:${GatewayServer.HttpPort}/application/client/v1/auth\n  path: /poverty/client/*\n  protocol: HTTP\n  responseFormat: true\n  timeout: ${PovertyServer.Timeout}\n"}]');
...
business:
  defaultPasswordExpire: 10s
  defaultNickName: 用户-
', 'AB3C721A133F848EDC1A4A015271B274', 1, 'yaml', '新增应用中心', '[{"type":"update","key":"server","old":"grpc:\n    host: ${UserCenterServer.Host}\n    port: ${UserCenterServer.GrpcPort}\n    timeout: ${UserCenterServer.Timeout}\nhttp:\n    host: ${UserCenterServer.Host}\n    marshal:\n        emitUnpopulated: true\n        useProtoNames: true\n    port: ${UserCenterServer.HttpPort}\n    timeout: ${UserCenterServer.Timeout}\n","cur":"grpc:\n    host: ${ApplicationServer.Host}\n    port: ${ApplicationServer.GrpcPort}\n    timeout: ${ApplicationServer.Timeout}\nhttp:\n    host: ${ApplicationServer.Host}\n    marshal:\n        emitUnpopulated: true\n        useProtoNames: true\n    port: ${ApplicationServer.HttpPort}\n    timeout: ${ApplicationServer.Timeout}\n"},{"type":"update","key":"database","old":"system:\n    autoCreate: true\n    config:\n        initializer:\n            enable: true\n            path: deploy/data.sql\n        logLevel: 4\n        maxIdleConn: 10\n        maxLifetime: 2h\n        maxOpenConn: 20\n        slowThreshold: 2s\n        transformError:\n            enable: true\n    connect:\n        dbName: ${UserCenterDatabase.Database}\n        host: ${UserCenterDatabase.Host}\n        option: ${UserCenterDatabase.Option}\n        password: ${UserCenterDatabase.Password}\n        port: ${UserCenterDatabase.Port}\n        username: ${UserCenterDatabase.Username}\n    drive: ${UserCenterDatabase.Type}\n    enable: true\n","cur":"system:\n    autoCreate: true\n    config:\n        initializer:\n            enable: true\n            path: deploy/data.sql\n        logLevel: 4\n        maxIdleConn: 10\n        maxLifetime: 2h\n        maxOpenConn: 20\n        slowThreshold: 2s\n        transformError:\n            enable: true\n    connect:\n        dbName: ${ApplicationDatabase.Database}\n        host: ${ApplicationDatabase.Host}\n        option: ${ApplicationDatabase.Option}\n        password: ${ApplicationDatabase.Password}\n        port: ${ApplicationDatabase.Port}\n        username: ${ApplicationDatabase.Username}\n    drive: ${ApplicationDatabase.Type}\n    enable: true\n"}]');
...
database:
  system:
    ...
    config:
      ...
      logLevel: 4 #日志等级
      slowThreshold: 2s #慢sql阈值
', 'D0ACCE3CA222DC8765CD13AAFD841EDD', 1, 'yaml', '修改应用中心', '[{"type":"update","key":"client","old":"- backends:\n    - target: ${ResourceServer.Host}:${ResourceServer.GrpcPort}\n  server: Resource\n  type: direct\n- backends:\n    - target: ${UserCenterServer.Host}:${UserCenterServer.GrpcPort}\n  server: UserCenter\n  type: direct\n","cur":"- backends:\n    - target: ${ResourceServer.Host}:${ResourceServer.GrpcPort}\n  server: Resource\n  type: direct\n- backends:\n    - target: ${ApplicationServer.Host}:${ApplicationServer.GrpcPort}\n  server: Application\n  type: direct\n"}]');
...
business:
  ...
  export:
    ...
    localDir: static/export
    expire: 72h
', 'A940188BE20724F72D54E3673D51C7FD', 1, 'yaml', '新增数据库日志', '[{"type":"update","key":"database","old":"system:\n    autoCreate: true\n    config:\n        initializer:\n            enable: true\n            path: deploy/data.sql\n        logLevel: 3\n        maxIdleConn: 10\n        maxLifetime: 2h\n        maxOpenConn: 20\n        slowThreshold: 2s\n        transformError:\n            enable: true\n    connect:\n        dbName: ${ResourceDatabase.Database}\n        host: ${ResourceDatabase.Host}\n        option: ${ResourceDatabase.Option}\n        password: ${ResourceDatabase.Password}\n        port: ${ResourceDatabase.Port}\n        username: ${ResourceDatabase.Username}\n    drive: ${ResourceDatabase.Type}\n    enable: true\n","cur":"system:\n    autoCreate: true\n    config:\n        initializer:\n            enable: true\n            path: deploy/data.sql\n        logLevel: 4\n        maxIdleConn: 10\n        maxLifetime: 2h\n        maxOpenConn: 20\n        slowThreshold: 2s\n        transformError:\n            enable: true\n    connect:\n        dbName: ${ResourceDatabase.Database}\n        host: ${ResourceDatabase.Host}\n        option: ${ResourceDatabase.Option}\n        password: ${ResourceDatabase.Password}\n        port: ${ResourceDatabase.Port}\n        username: ${ResourceDatabase.Username}\n    drive: ${ResourceDatabase.Type}\n    enable: true\n"}]');
...
business:
  aiBot:
    ...
    appid: ${botId}
    setting: ${botSetting}
', 'A52745FD56B8F35A884788911B482BA5', 1, 'yaml', '修改应用中心', '[{"type":"update","key":"client","old":"- backends:\n    - target: ${ResourceServer.Host}:${ResourceServer.GrpcPort}\n  server: Resource\n  type: direct\n- backends:\n    - target: ${UserCenterServer.Host}:${UserCenterServer.GrpcPort}\n  server: UserCenter\n  type: direct\n","cur":"- backends:\n    - target: ${ResourceServer.Host}:${ResourceServer.GrpcPort}\n  server: Resource\n  type: direct\n- backends:\n    - target: ${ApplicationServer.Host}:${ApplicationServer.GrpcPort}\n  server: Application\n  type: direct\n"}]');
